...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-[#fcfcf9] dark:bg-[#020617] text-[#0f172a] dark:text-[#f8fafc] font-sans selection:bg-amber-200 overflow-x-hidden">
      ...
      <section id="main-content" aria-label="Hero: Learn anything with AI" className="pt-32 pb-20 px-6 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-8">
              ...
              <motion.h1 initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }} className="text-5xl md:text-7xl font-bold leading-[1.1] tracking-tight font-serif">
              ...
              <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }} className="flex flex-col sm:flex-row gap-4">
                <Link href="/generate" className="group relative px-8 py-4 bg-gradient-to-r from-[#f59e0b] to-[#d97706] dark:from-[#fbbf24] dark:to-[#f59e0b] text-white rounded-xl font-semibold text-lg shadow-2xl shadow-amber-500/50 hover:shadow-amber-500/70 transition-all duration-300 flex items-center justify-center gap-3 overflow-hidden" aria-label="Generate your free AI course">
                  <span className="relative z-10 flex items-center gap-3">Generate Your Course Free<ArrowRight className="group-hover:translate-x-1 transition-transform" /></span>
            ...
            <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} transition={{ delay: 0.2 }} className="relative" aria-hidden="true">
              ...
              <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.8 }} className="absolute -right-4 -top-4 p-4 bg-white dark:bg-[#0f172a] rounded-2xl shadow-xl border border-slate-200 dark:border-slate-800">
                <div className="flex items-center gap-3">
              ...
              <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 1 }} className="absolute -left-4 bottom-8 p-4 bg-white dark:bg-[#0f172a] rounded-2xl shadow-xl border border-slate-200 dark:border-slate-800">
                <div className="flex items-center gap-3">
      ...
      <section id="how-it-works" aria-label="How Neurolearn AI works" className="py-24 px-6 bg-white dark:bg-[#0f172a]/50 border-y border-slate-200 dark:border-slate-800">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-4 font-serif">From Prompt to{" "}<span className="bg-gradient-to-r from-[#f59e0b] to-[#d97706] dark:from-[#fbbf24] dark:to-[#f59e0b] bg-clip-text text-transparent">Mastery</span></h2>
            <p className="text-xl text-slate-600 dark:text-slate-400 max-w-2xl mx-auto">Our AI analyzes your learning style and generates a complete educational experience in seconds</p>
          </div>
      ...
      <section aria-label="Neurolearn AI features" className="py-24 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-4 font-serif">Everything You Need to{" "}<span className="bg-gradient-to-r from-[#f59e0b] to-[#d97706] dark:from-[#fbbf24] dark:to-[#f59e0b] bg-clip-text text-transparent">Actually Learn</span></h2>
            <p className="text-xl text-slate-600 dark:text-slate-400 max-w-2xl mx-auto">Not just content delivery. A complete adaptive learning ecosystem powered by AI.</p>
          </div>
      ...
      <section aria-label="Learning outcomes and statistics" className="py-24 px-6 bg-white dark:bg-[#0f172a]/50 border-y border-slate-200 dark:border-slate-800">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-4 font-serif">AI Learning That Actually{" "}<span className="bg-gradient-to-r from-[#f59e0b] to-[#d97706] dark:from-[#fbbf24] dark:to-[#f59e0b] bg-clip-text text-transparent">Works</span></h2>
            <p className="text-xl text-slate-600 dark:text-slate-400 max-w-2xl mx-auto">Data-driven results from thousands of learners</p>
          </div>
          <dl className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
              ...
              <div key={i} className="text-center group">
                <dd className="text-5xl md:text-6xl font-bold mb-2 bg-gradient-to-r from-[#f59e0b] to-[#d97706] dark:from-[#fbbf24] dark:to-[#f59e0b] bg-clip-text text-transparent font-serif">{stat.val}</dd>
      ...
      <section aria-label="Browse subjects available on Neurolearn AI" className="py-24 px-6 bg-slate-50 dark:bg-[#0f172a]/30">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-4 font-serif">Learn{" "}<span className="bg-gradient-to-r from-[#f59e0b] to-[#d97706] dark:from-[#fbbf24] dark:to-[#f59e0b] bg-clip-text text-transparent">Literally Anything</span></h2>
            <p className="text-xl text-slate-600 dark:text-slate-400 max-w-2xl mx-auto">From programming to philosophy, music theory to machine learning — generate a free AI course on any topic instantly</p>
          </div>
      ...
      <section aria-label="Popular AI learning paths" className="py-16 px-6 bg-white dark:bg-[#0f172a]/50 border-t border-slate-200 dark:border-slate-800">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-10">
            <h2 className="text-3xl md:text-4xl font-bold mb-3 font-serif">Popular{" "}<span className="bg-gradient-to-r from-[#f59e0b] to-[#d97706] dark:from-[#fbbf24] dark:to-[#f59e0b] bg-clip-text text-transparent">Learning Paths</span></h2>
            <p className="text-lg text-slate-600 dark:text-slate-400">Jump into one of our most popular AI-generated courses</p>
          </div>
      ...
      <section aria-label="Frequently asked questions about Neurolearn AI" className="py-24 px-6 bg-slate-50 dark:bg-[#0f172a]/30 border-t border-slate-200 dark:border-slate-800">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-4 font-serif">Frequently Asked{" "}<span className="bg-gradient-to-r from-[#f59e0b] to-[#d97706] dark:from-[#fbbf24] dark:to-[#f59e0b] bg-clip-text text-transparent">Questions</span></h2>
            <p className="text-xl text-slate-600 dark:text-slate-400">Everything you need to know about Neurolearn AI</p>
          </div>
      ...
      <section aria-label="Get started with Neurolearn AI for free" className="relative py-32 px-6 overflow-hidden bg-white dark:bg-[#0f172a]/50 border-y border-slate-200 dark:border-slate-800">
        ...
        <div className="relative max-w-6xl mx-auto">
          <div className="text-center space-y-8">
            ...
            <motion.h2 initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.1 }} className="text-5xl md:text-7xl font-bold leading-tight font-serif text-[#0f172a] dark:text-[#f8fafc]">
            ...
            <motion.p initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.2 }} className="text-xl md:text-2xl text-slate-600 dark:text-slate-400 max-w-3xl mx-auto font-light">
            ...
            <motion.div initial={{ opacity: 0, scale: 0.95 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} transition={{ delay: 0.3 }} className="max-w-2xl mx-auto">
              <div className="relative">
                ...
                <input id="cta-course-input" type="text" aria-label="Enter a topic to generate your free AI course" placeholder="e.g., Machine Learning for Beginners..." value={ctaTopic} onChange={(e) => setCtaTopic(e.target.value)} onKeyDown={(e) => e.key === "Enter" && handleCtaGenerate()} className="w-full px-8 py-6 text-lg bg-white/95 backdrop-blur-sm text-[#0f172a] rounded-2xl border-2 border-white/50 focus:border-white outline-none shadow-2xl placeholder:text-slate-400" />
                <button onClick={handleCtaGenerate} className="absolute right-2 top-1/2 -translate-y-1/2 px-8 py-4 bg-gradient-to-r from-[#f59e0b] to-[#d97706] text-white rounded-xl font-bold hover:shadow-xl hover:scale-105 transition-all flex items-center gap-2" aria-label="Generate free AI course">
                  Generate Free Course<ArrowRight size={20} aria-hidden="true" />
                </button>
              </div>
            </motion.div>
      ...
      <footer aria-label="Site footer" className="py-16 px-6 border-t border-slate-200 dark:border-slate-800 bg-white dark:bg-[#0f172a]/50">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-12 gap-12 mb-12">
            ...
            <nav aria-label="Platform links" className="lg:col-span-2 space-y-4">
            ...
            <nav aria-label="Company links" className="lg:col-span-2 space-y-4">
...
const FeatureCard = ({ icon, title, description, gradient }: { icon: React.ReactNode; title: string; description: string; gradient: string }) => (
  <article className="group relative p-8 bg-white dark:bg-[#0f172a] border border-slate-200 dark:border-slate-800 rounded-2xl hover:border-[#f59e0b] dark:hover:border-[#fbbf24] transition-all hover:shadow-xl">
    ...
    <div className="relative space-y-4">
      ...
      <h3 className="text-xl font-bold text-[#0f172a] dark:text-[#f8fafc] font-serif">{title}</h3>
