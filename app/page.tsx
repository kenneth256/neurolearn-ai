...
const LandingPage = () => {
  return (
    <div className="min-h-screen bg-[#fcfcf9] dark:bg-[#020617] text-[#0f172a] dark:text-[#f8fafc] font-sans selection:bg-amber-200 overflow-x-hidden">
            ...
            >
              <div className="relative bg-white dark:bg-[#0f172a] rounded-3xl shadow-2xl border border-slate-200 dark:border-slate-800 p-8 space-y-6">
                <div className="space-y-3">
                  <label htmlFor="hero-course-input" className="text-xs font-semibold uppercase tracking-wider text-slate-500 dark:text-slate-400">
                    What do you want to learn?
                  </label>
                  <div className="relative">
                    <input
                      id="hero-course-input"
                      type="text"
      ...
      <section className="relative py-32 px-6 overflow-hidden bg-white dark:bg-[#0f172a]/50 border-y border-slate-200 dark:border-slate-800">
        ...
        <div className="relative max-w-6xl mx-auto">
          <div className="text-center space-y-8">
            ...
            >
              <div className="relative">
                <label htmlFor="cta-course-input" className="sr-only">Course Topic</label>
                <input
                  id="cta-course-input"
                  type="text"
      ...
      <footer className="py-16 px-6 border-t border-slate-200 dark:border-slate-800 bg-white dark:bg-[#0f172a]/50">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-12 gap-12 mb-12">
            <div className="lg:col-span-4 space-y-6">
              ...
              <p className="text-slate-500 dark:text-slate-400 text-sm leading-relaxed max-w-sm">
                Unlock your potential with dynamic, AI-generated courses customized to your exact learning style and goals.
              </p>
              <div className="flex items-center gap-4">
                <a href="https://twitter.com/neurolearnai" aria-label="Twitter" className="text-slate-400 hover:text-[#f59e0b] dark:hover:text-[#fbbf24] transition-colors">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path d="M8.29 20.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0022 5.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743 11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27 5.477A4.072 4.072 0 012.8 9.713v.052a4.105 4.105 0 003.292 4.022 4.095 4.095 0 01-1.853.07 4.108 4.108 0 003.834 2.85A8.233 8.233 0 012 18.407a11.616 11.616 0 006.29 1.84" /></svg>
                </a>
                <a href="https://github.com/neurolearnai" aria-label="GitHub" className="text-slate-400 hover:text-[#f59e0b] dark:hover:text-[#fbbf24] transition-colors">
            ...
            <div className="lg:col-span-4 space-y-4">
              ...
              <div className="rounded-xl overflow-hidden border border-slate-200 dark:border-slate-800 shadow-sm h-40 relative bg-slate-100 dark:bg-slate-800">
                <iframe
                  ...
                  title="Neurolearn AI Headquarters"
                ></iframe>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-4 pt-8 border-t border-slate-200 dark:border-slate-800">
            <div className="text-sm text-slate-500 dark:text-slate-400">
              © {new Date().getFullYear()} NeuronLearn AI. All rights reserved.
            </div>
